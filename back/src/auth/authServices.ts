...
export const login = async (name: string, password: string): Promise<CustomResponseServiceType<string>> => {
    const [error, user] = await getUserByName(name);
